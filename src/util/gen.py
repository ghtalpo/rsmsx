...
ops = ['CALL', 'LD', 'XOR', 'OR', 'CP', 'PUSH', 'POP', 'INC', 'DEC', 'JP', 'JR','ADD', 'ADC', 'SUB', 'SBC', 'AND', 'EX', 'RET', 'OUT', 'BIT', 'RES', 'DJNZ', 'SRL', 'RR']
            ...
            if op == 'CALL':
                ...
                if is_reg16(oprr[0]):
                    ...
                    if re.match(r'^[\d]', oprr[1]):
                        ...
                        return "self.instr_hk__LD_%s_NN(%s as u32 as u8);" % (oprr[0],oprr[1])
                    elif oprr[1].startswith('('):
                        tgt = oprr[1][1:].rstrip(')').rstrip()
                        if is_reg16(tgt[:2]):
                ...
                if is_reg16(oprr[0]) and is_reg16(oprr[1]):
                    ...
                    if is_reg8(oprr[1]):
                        ...
                        return "self.instr_hk__%s_A_NN(%s as u32 as u8);" % (op, oprr[1])
                    else:
